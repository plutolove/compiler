...
rule("dep_gen")
  before_build(function(target)
	  os.vrun(
		  "java -jar ./tools/antlr-4.12.0-complete.jar -visitor -no-listener -Dlanguage=Cpp -package sql ./src/parser/SQLParser.g4 -o ./"
	  )
...
target("main")
  ...
  add_packages("antlr4", "libllvm", "fmt", "abseil", "spdlog")
